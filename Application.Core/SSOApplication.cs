...
namespace Application.Core
{
    public class SSOApplication : ISSOApplication
    {
        ...
        //    catch (Exception ex)
        //    {
        //        throw new Exception($"({SERVICE_NAME}) : {ex.Message}");
        //    }
        //}
        ...
        //        var responseLogin = new Response<SSODto.Login.Response>();
        //        var httpClient = new HttpClient();
        //        var requestBody = new
        //        {
        ...
        //            UserName = oItem.sUsername,
        //            UserPassword = oItem.sPassword
        //        };
        //        var contentRequest = new StringContent(
        //            JsonConvert.SerializeObject(requestBody),
        //            Encoding.UTF8,
        ...
        //        httpClient.BaseAddress = new Uri(_configuration.GetSection("Servicios").GetSection("MiddleWareAPI").Value);
        //        httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", sToken);
        ...
        //        responseLogin.Data = null; // ssoModel.Data.IdUsuario;
        //        return responseLogin;
        //    }
        //    catch (Exception ex)
        //    {
