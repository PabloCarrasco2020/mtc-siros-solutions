    ...
    public class ContratoEsRepository : IContratoEsRepository
    {
        ...
        public async Task<TM_CONTRATOES> Insert(TM_CONTRATOES input)
        {
            using (var connection = _connectionFactory.GetConnectionSIROS())
            {
                ...
                dyParam.Add("num_identidad_", OracleDbType.Int32, ParameterDirection.Input, input.NUM_IDENTIDAD);
                dyParam.Add("str_numcontrato_", OracleDbType.Varchar2, ParameterDirection.Input, input.STR_NUMCONTRATO);
                dyParam.Add("dte_feccontrato_", OracleDbType.Varchar2, ParameterDirection.Input, input.DTE_FECCONTRATO.GetSirosDate());
                dyParam.Add("dte_fecinivig_", OracleDbType.Varchar2, ParameterDirection.Input, input.DTE_FECINIVIG.GetSirosDate());
                dyParam.Add("dte_fecvenvig_", OracleDbType.Varchar2, ParameterDirection.Input, input.DTE_FECVENVIG.GetSirosDate());
